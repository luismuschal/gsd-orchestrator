...
<task type="checkpoint:human-verify" gate="blocking">
  <name>Verify complete Phase 1 functionality</name>
  <action>
Human testing verification of complete Phase 1 system:
...
If issues found, describe what didn't work and execution will resume to address them.
  ...
  <done>
All 7 Phase 1 requirements verified working through human testing:
- AUTH-01: GitHub OAuth authentication works
- AUTH-02: Repo configuration via dashboard works
- AUTH-03: GitHub API connection maintained
- DASH-01: Unified dashboard displays all repos
- DASH-02: Real-time workflow status updates
- DASH-03: Visual status indicators accurate
- EXEC-01: Manual workflow triggering works
  </done>
</task>
